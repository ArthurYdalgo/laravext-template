        ...
        <div className="bg-white dark:bg-zinc-900 border border-gray-200 dark:border-zinc-800 shadow-sm rounded-xl mb-4 overflow-hidden text-sm flex flex-col w-full min-w-0 box-border">
            ...
            <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-zinc-800/60 min-w-0">
                <div className="flex items-center gap-3 overflow-hidden min-w-0 flex-1">
                    ...
                    {title && <span className="font-semibold text-gray-900 dark:text-gray-100 truncate min-w-0 block">{title}</span>}
                </div>
                {actions && (
                    <div className="flex items-center gap-4 text-gray-400 dark:text-zinc-500 flex-shrink-0 ml-4">
                        {actions}
                    </div>
                )}
            </div>
            ...
            {fakeViewMore ? (
                ...
                minorProps.length > 0 && (
                    <div className="border-t border-gray-100 dark:border-zinc-800/60 min-w-0">
                        <button
                            type="button"
